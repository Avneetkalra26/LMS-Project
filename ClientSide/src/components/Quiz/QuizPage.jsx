...
return (
    <div>
        <h1 className='py-6 fs-4 bg-gradient-to-r from-purple-800 via-cyan-600 to-violet-700 inline-block text-transparent bg-clip-text'>You are about to start a Quiz: {idTitle}</h1>
        <div className="row">
