    ...
    return (
        <div className="mx-5 mt-5 flex items-center justify-between">
            <div className='flex gap-6'>
                <font className='text-xl fw-semibold ' style={{ color: "#611f69", textShadow: "3px 3px 3px violet" }}>
                    {courseTitle}
                </font>
            ...
            <Link to="/mainpage">
                <button onClick={play} className='px-7 py-2 text-white rounded-lg mr-4' style={{ backgroundColor: "#611f69", border: "none" }}>
                    Back
                </button>
            </Link>
        </div>
