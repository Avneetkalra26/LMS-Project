    ...
    return (
        <div className="mx-4 mt-4 flex items-center justify-between">
            <div className='flex gap-6'>
                <font className='fs-5'
                    style={{ color: "#611f69", textShadow: "3px 3px 3px violet" }}>{idTitle}</font>
                <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-36 outline-none p-2.5 ">
