            ...
            <div className={`p-6 my-6 w-3/5 `}>
                <div className="flex rounded-lg  m-8 px-4 pt-2 pb-1 shadow-md">
                    ...
                    <div className="card-body ml-10">
                        <form class="max-w-xs mt-6 mx-auto">
                        <div className={`card-title font-bold text-xl mt-2 mb-7 ml-2 ${style.pageTitle}`}>
                            Sign In
                        </div>
                            <div className="mb-4">
                                <label for="name" class="block mb-2 text-sm font-semibold text-gray-700 ml-3">Name</label>
                                <div class="relative">
                            ...
                            <div className="mb-5">
                                <label for="userPassword" class="block mb-2 text-sm font-semibold text-gray-700 ml-3">Password</label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                            ...
                            <Link to="/mainpage">
                                <button type="button" className={`text-white text-center text-md fw-bolder mb-3 rounded-full block w-full p-2 ${style.btnBgColor}`}>Sign In</button>
                            </Link>
                            <Link to="/registration">
                            <p className='text-center cursor-pointer mb-6'><span className='text-xs' style={{ color: "#B20303" }}>Not an Account?</span>
                                <span className='text-xs fw-bolder ml-1' style={{ color: "#B20303" }}>Create Account</span>
                            </p>
                            </Link>
                        </form>
                    </div>
